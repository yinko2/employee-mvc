        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AllowedAccessTokenSigningAlgorithms = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ShowInDiscoveryDocument = table.Column<bool>(type: "bit(1)", nullable: false),
                    Created = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    Updated = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    LastAccessed = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    NonEditable = table.Column<bool>(type: "bit(1)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Emphasize = table.Column<bool>(type: "bit(1)", nullable: false),
                    ShowInDiscoveryDocument = table.Column<bool>(type: "bit(1)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProtocolType = table.Column<string>(type: "varchar(200)", maxLength: 200, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    RequireClientSecret = table.Column<bool>(type: "bit(1)", nullable: false),
                    ...
                    LogoUri = table.Column<string>(type: "varchar(2000)", maxLength: 2000, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    RequireConsent = table.Column<bool>(type: "bit(1)", nullable: false),
                    AllowRememberConsent = table.Column<bool>(type: "bit(1)", nullable: false),
                    AlwaysIncludeUserClaimsInIdToken = table.Column<bool>(type: "bit(1)", nullable: false),
                    RequirePkce = table.Column<bool>(type: "bit(1)", nullable: false),
                    AllowPlainTextPkce = table.Column<bool>(type: "bit(1)", nullable: false),
                    RequireRequestObject = table.Column<bool>(type: "bit(1)", nullable: false),
                    AllowAccessTokensViaBrowser = table.Column<bool>(type: "bit(1)", nullable: false),
                    FrontChannelLogoutUri = table.Column<string>(type: "varchar(2000)", maxLength: 2000, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    FrontChannelLogoutSessionRequired = table.Column<bool>(type: "bit(1)", nullable: false),
                    BackChannelLogoutUri = table.Column<string>(type: "varchar(2000)", maxLength: 2000, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    BackChannelLogoutSessionRequired = table.Column<bool>(type: "bit(1)", nullable: false),
                    AllowOfflineAccess = table.Column<bool>(type: "bit(1)", nullable: false),
                    ...
                    UpdateAccessTokenClaimsOnRefresh = table.Column<bool>(type: "bit(1)", nullable: false),
                    RefreshTokenExpiration = table.Column<int>(type: "int", nullable: false),
                    AccessTokenType = table.Column<int>(type: "int", nullable: false),
                    EnableLocalLogin = table.Column<bool>(type: "bit(1)", nullable: false),
                    IncludeJwtId = table.Column<bool>(type: "bit(1)", nullable: false),
                    AlwaysSendClientClaims = table.Column<bool>(type: "bit(1)", nullable: false),
